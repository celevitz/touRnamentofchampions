...
bracketfunction <- function(seasonnumber,xlimits,xbreaks,xlabs,titlenumber,roundtolabel) {
  ...
  ## Plot
    ...
    scale_size_manual(values=c(3,4,5,6,4),name="Score legend",labels=sort(unique(bumpdata$sizeofdot)) ) +
    ...
    theme(panel.grid = element_blank()
          ...
          ,plot.subtitle=element_text(hjust=.5,color="black",size=18)
...
## set the inputs for the function
  ...
  # season 3
    ...
    xlabs <- c("Round of 32","Round of 16","Quarter-\nfinal","Semi-\nfinal",
